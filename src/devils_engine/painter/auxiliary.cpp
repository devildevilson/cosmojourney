...
const phmap::flat_hash_map<uint32_t, VULKAN_FORMAT_INFO> vk_format_table = {
...
// clang-format off
const phmap::flat_hash_map<uint32_t, VULKAN_MULTIPLANE_COMPATIBILITY> vk_multiplane_compatibility_map {
